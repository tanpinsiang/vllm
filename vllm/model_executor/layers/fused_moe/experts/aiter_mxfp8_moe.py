...
class AiterMxfp8Experts(Mxfp8TritonExpertsBase):
    ...
    def apply(
        ...
        # Mirror the generic AITER MoE copy-elision path: rebind an owning,
        # contiguous output tensor when the AITER result already has the
        # requested layout. Preserve copy semantics for views or mismatches.
        if (
